...
import { AddAgentInfoRequest, AgentInfoRequest, AgentInfoResponse, AppInfo, AppInfoResponse, AttachAppInterfaceRequest, AttachAppInterfaceResponse, CallZomeRequestSigned, CreateCloneCellRequest, CreateCloneCellResponse, DeleteCloneCellRequest, DisableAppRequest, DisableAppResponse, DisableCloneCellRequest, DisableCloneCellResponse, DnaDefinition, DumpFullStateRequest, DumpStateRequest, DumpStateResponse, EnableAppRequest, EnableAppResponse, EnableCloneCellRequest, EnableCloneCellResponse, FullStateDump, GetDnaDefinitionRequest, GrantZomeCallCapabilityRequest, HoloHash, InstallAppRequest, ListAppInterfacesResponse, ListAppsRequest, ListAppsResponse, ListCellIdsResponse, ListDnasResponse, RegisterDnaRequest, StartAppRequest, StartAppResponse, UninstallAppRequest, UninstallAppResponse } from "@holochain/client";
 ...
 * @internal
 */
export type _TryCpSuccessResponseSeralized = typeof TRYCP_SUCCESS_RESPONSE | string | Uint8Array;
/**
 ...
 * @public
 */
export declare const TRYCP_SUCCESS_RESPONSE: null;
/**
 ...
 * @internal
 */
export type _TryCpResponseWrapper = _TryCpResponseWrapperResponse | _TryCpResponseWrapperSignal;
/**
 * @internal
 */
