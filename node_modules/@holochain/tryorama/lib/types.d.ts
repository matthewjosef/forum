import type { AdminWebsocket, AgentPubKey, AppBundleSource, AppSignalCb, AppWebsocket, CallZomeRequest, ClonedCell, DnaBundle, DnaProperties, DnaSource, HoloHash, InstalledAppId, MembraneProof, ProvisionedCell, RegisterDnaRequest, RoleName } from "@holochain/client";
/**
 * @internal
 */
export type _RegisterDnaReqOpts = Omit<RegisterDnaRequest, "hash" | "path" | "bundle"> & {
    hash?: HoloHash;
    path?: string;
    bundle?: DnaBundle;
};
